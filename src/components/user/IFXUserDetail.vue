    ...
    <v-container>
      ...
      <span>
        ...
        <v-row dense>
          <v-col sm="3" md="3">
            ...
            <div>
              <v-switch v-model="showInactiveAffiliations" label="Show Inactive" class="small-checkbox mt-0" color="primary" hide-details></v-switch>
            </div>
          </v-col>
          <v-col>
      ...
      <v-row dense v-if="areAnyAccountsPresent">
        <v-col sm="4" md="3">
          ...
          <div>
            <v-switch v-model="showInactiveAccounts" label="Show Inactive" class="small-checkbox mt-0" color="primary" hide-details></v-switch>
          </div>
        </v-col>
        <v-col>
