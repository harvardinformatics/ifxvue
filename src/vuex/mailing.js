...
const getters = {
  ...
  to: (state) => state.to,
  tostr: (state) => state.to.map(item => (item.name ? item.name : item)).join(', '),
  from: (state) => state.from,
  fromstr: (state) => state.from,
  cc: (state) => state.cc,
  ccstr: (state) => state.cc.map(item => (item.name ? item.name : item)).join(', '),
  bcc: (state) => state.bcc,
  bccstr: (state) => state.bcc.map(item => (item.name ? item.name : item)).join(', '),
